...
from .iiitd_20k import IIITD20K

__factory = {'CUHK-PEDES': CUHKPEDES, 'ICFG-PEDES': ICFGPEDES, 'RSTPReid': RSTPReid, 'IIITD-20K': IIITD20K}
        ...
        if args.MLM:
            train_set = ImageTextMLMDataset(dataset.train,
                                     ...
                                     text_length=args.text_length,
                                            mask_token_ratio=args.mask_token_ratio)
        else:
